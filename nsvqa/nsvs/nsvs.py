...
def run_nsvs(
    ...
    event_clusters = group_into_continuous_events(frames_with_indices, gap_threshold=gap_thres)
    ...
    all_pixels, all_patches = model.parallel_preprocess_video(images_to_process, num_workers=10)
