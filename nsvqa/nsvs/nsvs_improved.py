...
def run_nsvs(
    ...
    def process_frame(sequence_of_frames: list[np.ndarray], frame_count: int, measure_metrics: bool, proposition: list):
        object_of_interest = {}    
    ...
    for i, sequence_of_frames in looper:
        ...
        try:
            frames = process_frame(sequence_of_frames, i, measure_metrics, proposition)
